...
class ET_Builder_Module_JarvisLibraryBookList extends ET_Builder_Module_Type_PostBased {
	function init() {
		$this->name       = esc_html__( 'Jarvis - Library (Book List)', 'et_builder' );
		$this->slug       = 'et_pb_library-booklist';
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$args['post_type'] = array('rcno_review');
		query_posts( $args );
...
new ET_Builder_Module_JarvisLibraryBookList;